...
public enum ListSymbolSportRecreation {
    case soccerBall
    case basketball
...
extension ListSymbolSportRecreation: CaseIterable {
    public static var allCases: [ListSymbolSportRecreation] {
        return [
            .soccerBall, .basketball, .americanFootball, .baseball, .baseballDiamond, .rugbyBall, .tennisBall,
            .tennisRacket, .volleyball, .hockeyPuck, .surfboard, .skis, .snowboard, .dumbBell, .oars, .medal,
            .medalStar, .trophy, .running
        ]
    }
}
