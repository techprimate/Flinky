.PHONY: build-ios build-core-ios test-ios test-core-ios test-ui-ios format lint generate generate-licenses generate-localization generate-app-store-summary generate-app-icons generate-screenshots publish-beta-build
